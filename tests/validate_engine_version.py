...
if 'config/version="6.3.1"' not in project:
    errors.append("application version was not bumped to 6.3.1")
export = (root / "export_presets.cfg").read_text(encoding="utf-8")
if 'version/code=20' not in export or 'version/name="6.3.1"' not in export:
    errors.append("Android version is not 20 / 6.3.1")
...
print(f"ENGINE VERSION OK: Godot 4.7.1-stable, app 6.3.1 (Android 20), {len(uids)} script UIDs")
