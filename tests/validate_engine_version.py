...
if not ('config/version="6.3.1"' in project or 'config/version="6.4.0' in project):
    errors.append("application version is not 6.3.1 or 6.4.0")
export = (root / "export_presets.cfg").read_text(encoding="utf-8")
if not (('version/code=20' in export or 'version/code=21' in export) and ('version/name="6.3.1"' in export or 'version/name="6.4.0' in export)):
    errors.append("Android version is not 20/21 / 6.3.1/6.4.0")
...
print(f"ENGINE VERSION OK: Godot 4.7.1-stable, app 6.4.0 (Android 21), {len(uids)} script UIDs")
