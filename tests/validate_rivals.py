...
# حلقهٔ ماهانه بدون RNG: توالی دترمینستیک سراسری نباید جابه‌جا شود (درس CI ۴۹)
check("بدون مصرف RNG در حلقهٔ ماهانه", "Deterministic." not in rm,
      "رقبا از RNG سراسری استفاده می‌کنند — توالی سایر سیستم‌ها/تست‌ها جابه‌جا می‌شود")
check("قرعهٔ کودتای فرمول‌محور", "% 100 < int(COUP_CHANCE * 100.0)" in rm,
      "قرعهٔ کودتا دترمینستیک نیست")
